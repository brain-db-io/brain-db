...
The same glossary is also hosted in [`../01_architecture/08_glossary.md`](../01_architecture/08_glossary.md) for cross-spec reference; the two files MUST stay in sync.
