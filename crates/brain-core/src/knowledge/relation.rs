...
//! (phase 18.6).
//!
//! See `spec/20_relations/00_purpose.md` for the canonical schema and
//! `spec/20_relations/{01_cardinality, 02_symmetric, 03_storage, 04_traversal, 05_evidence}.md`
//! for the per-concern contracts.

use serde::{Deserialize, Serialize};

use crate::knowledge::ids::{EntityId, EntityTypeId, ExtractorId, RelationId, RelationTypeId};
use crate::knowledge::kinds::Cardinality;
use crate::MemoryId;
...
/// (spec §02) and dual-index population so reads from either endpoint
/// find the relation.
...
mod tests {
    use super::*;
    use crate::knowledge::ids::{EntityId, ExtractorId, RelationId, RelationTypeId};
