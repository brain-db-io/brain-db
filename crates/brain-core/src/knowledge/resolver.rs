...
use crate::knowledge::{trigrams, AuditId, EntityId, EntityTypeId};
...
/// returns `Ambiguous` rather than picking arbitrarily. Spec §18/01
...
mod algorithm_tests {
    ...
    fn person() -> EntityTypeId {
        crate::knowledge::EntityType::PERSON_ID
    }
