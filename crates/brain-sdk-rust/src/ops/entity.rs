...
use crate::models::entity::Person;
use crate::models::entity::{BrainEntityType, EntityHandle, EntityHandleFromViewError};
use crate::models::errors::ClientErrorEntityExt;
...
/// method or a chainable builder; see the [`crate::ops::entity`]
