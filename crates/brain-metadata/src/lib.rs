...
pub use entity::ops::{
    ...
    entity_resolve_canonical_all_types, entity_tombstone, entity_update, normalize_name,
    EntityOpError,
};
...
pub use schema::predicate::{
    ...
    predicate_review_list, predicate_review_record, render_declared_predicates_block,
    PredicateOpError,
};
